...
def run(ctx):
    ...
    p20m = ctx.load_instrument(
        "p20_multi_gen2", "right", tip_racks=[
            ctx.load_labware(
    ...
    p300s.distribute(
        ...
        new_tip='once')
    c20.get_tip()
    p20m.transfer(2, dna_wells, thermo_wells, new_tip='always')
    ...
    c20.get_tip()
    p300s.distribute(17.5, kapa_mm, thermo_wells)
    c20.get_tip()
    p20m.transfer(2.5, dna_wells, thermo_wells)
